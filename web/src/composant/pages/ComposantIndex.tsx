...
import { COMPOSANT_ENTRIES, STATUS_LABEL } from '@/composant/entries'

/** Index de l'archive des prototypes : une carte par demo. */
    ...
    >
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        {COMPOSANT_ENTRIES.length === 0 ? (
          ...
          >
            {COMPOSANT_ENTRIES.map((c) => (
              <Link
                key={c.slug}
                href={`/composant/${c.slug}`}
                style={{
                  display: 'block',
                  padding: '1.5rem',
                  borderRadius: '14px',
