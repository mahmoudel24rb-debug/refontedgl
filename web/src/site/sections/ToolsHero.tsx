...
import GeoScanStartForm from '../tools/geoscan/GeoScanStartForm'

/**
 * Hero de la page Outils : pastille, titre centre, grande carte navy
 * contenant le formulaire reel du test de visibilite IA (lot 6) puis
 * la liste des IA suivies en logos typographiques.
 */
...
export default function ToolsHero() {
  const { pill, title, eyebrow, ai } = TOOLS_PAGE
