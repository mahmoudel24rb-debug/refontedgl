...
export type SiteRoute = '/' | '/realisations' | '/outils' | '/tarifs' | '/blog'
...
export const FOOTER: FooterContent = {
  ...
  columns: [
    ...
    },
    {
      ...
      links: [
        {
          label: 'Simulateur de ROI',
          href: 'https://dgl-agency.fr/simulateur-de-roi/',
          external: true,
        },
        {
          label: 'Test PageSpeed',
        ...
        { label: 'Test de visibilité IA', href: TEST_IA_URL, external: true },
        {
...
export const TOOLS_PAGE: ToolsPageContent = {
  ...
  form: {
    fields: ['Votre entreprise', 'Votre métier', 'Votre ville'],
    href: TEST_IA_URL,
