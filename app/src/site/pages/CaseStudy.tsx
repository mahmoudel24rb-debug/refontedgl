...
import { useFadeUp, useGrowBar } from '../cases/motion'
import {
  getCase,
  getOtherCases,
  type CaseMetric,
...
/**
 * Page cas client `/realisations/:slug` : en-tete, chiffres cles, projet,
 * livrables, processus, resultats (metriques, positions SEO, galerie),
 * temoignage, autres realisations et FAQ.
 */
...
function CaseStudyView({ study }: { study: Study }) {
  const fade = useFadeUp()
  const project = findProject(study.projectSlug)
